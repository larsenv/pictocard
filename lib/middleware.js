...
function csrf() {
  return function csrfMiddleware(req, res, next) {
    ...
    // Skip validation for multipart/form-data here, as req.body isn't parsed yet.
    // Those routes MUST call validateCsrf manually after multer.
...
/**
 * Manual CSRF validation helper for routes that parse their own bodies (like multer).
 */
...
module.exports = { rateLimit, csrf, validateCsrf };
